...
import { BsFillBagFill,BsFillStarFill,BsGiftFill,BsFillQuestionCircleFill } from "react-icons/bs";
...
export default function Footer() {
  return (
    <Box
      bg={useColorModeValue("#051037", "gray.900")}
    ...
    >
      <Container as={Stack} maxW={"6xl"} py={10}>
        <SimpleGrid columns={{ base: 1, sm: 3, md: 6 }} spacing={8}>
          <Stack align={"flex-start"}>
            <ListHeader color="grey">ABOUT</ListHeader>
          ...
          <Stack align={"flex-start"}>
            ...
            <Link href={"#"}>Cscellation & Returns</Link>
            <Link href={"#"}>FAQ</Link>
          ...
          <Box borderLeft="1px solid" borderColor="gray.400">
            <Stack align={"flex-start"} marginLeft="20%">
              ...
              <Link >Bengaluru, 560103,</Link>
              <Link >Karnataka, India</Link>
            </Stack>
      ...
      <Box py={10}>
        ...
        <Flex justifyContent="space-evenly" marginTop="2%">
          <Box>
          <Icon as={BsFillBagFill} />
            Become a Seller</Box>
          <Box>
            <Icon as={BsFillStarFill}/>
            Advirtise</Box>
          <Box><Icon as={BsGiftFill}/>
            Gift Cards</Box>
          <Box> <Icon as={BsFillQuestionCircleFill}/>
            Help Center</Box>
